...
**Solution:**  
1. **Stricter contamination rate** (0.5% instead of 5%) to focus only on critical threats
2. **10-point rolling mean** to give the AI "short-term memory" - comparing current state against recent trends, not just static baselines
...
- **Johns Hopkins University:** *Artificial Intelligence for Industrial Control Systems Security* (Dec 2025)
